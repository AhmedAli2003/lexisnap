...
class _WordsRemoteDataSource implements WordsRemoteDataSource {
  _WordsRemoteDataSource(
    ...
    baseUrl ??= 'https://lexisnap.onrender.com/api/v1/words';
  }
  ...
  Future<ApiResponse<List<MinimalWordModel>>> getWordsOverview(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<List<MinimalWordModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ApiResponse<List<MinimalWordModel>>.fromJson(
      ...
      (json) => json is List<dynamic>
          ? json
              .map<MinimalWordModel>(
                  (i) => MinimalWordModel.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    return value;
  ...
  Future<PaginationResponse<List<WordModel>>> getAllWords({
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PaginationResponse<List<WordModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PaginationResponse<List<WordModel>>.fromJson(
      ...
      (json) => json is List<dynamic>
          ? json
              .map<WordModel>(
                  (i) => WordModel.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    return value;
  ...
  Future<ApiResponse<WordModel>> getWordById({
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<WordModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
